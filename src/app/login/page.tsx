                    ...
                    <form onSubmit={handleSubmit} className='space-y-2'>
                        <RenderIf condition={newUserState}>
                            ...
                            <div className='mt-2'>
                                ...
                                <FieldError error={errors.name} style='text-red-500'/>
                            </div>
                        ...
                        <div className='mt-2'>
                            <InputText style='w-full'
                                ...
                                value={values.email}
                                onChange={handleChange}/>
                                <FieldError error={errors.email} style='text-red-500'/>
                        </div>
                        ...
                        <div className='mt-2'>
                            <InputText style='w-full'
                                ...
                                onChange={handleChange}/>
                                 <FieldError error={errors.password} style='text-red-500'/>
                        </div>
                        ...
                        <RenderIf condition={newUserState}>
                            ...
                            <div className='mt-2'>
                                <InputText style='w-full'
                                    ...
                                    onChange={handleChange}/>
                                    <FieldError error={errors.passwordMatch} style='text-red-500'/>
                            </div>
                        </RenderIf>
